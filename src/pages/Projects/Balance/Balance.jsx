    ...
    <div className="project balance">
      ...
      <section className="subsection subsection2">
        <div className="content">
          ...
          <div className="content__right">
            <p className="content__text">To learn more about Balance, check out these articles and blog posts.</p>
          </div>
        </div>
      </section>
      ...
      <section className="subsection subsection3">
        <div className="content">
          ...
          <div className="content__right">
            <p className="content__text">This project is still ongoing and due to my NDA, I will not be able to provide more details at this moment.</p>
